import fui_PopupMenuitem from "../../Generates/System/fui_PopupMenuitem";
import SystemWin from "../../../gamemodule/Windows/SystemWin";

/** 此文件自动生成，可以直接修改，后续不会覆盖 **/
export default class UI_PopupMenuitem extends fui_PopupMenuitem {
	...
	public static createInstance(): UI_PopupMenuitem {
		return <UI_PopupMenuitem>(fui_PopupMenuitem.createInstance());
	}
