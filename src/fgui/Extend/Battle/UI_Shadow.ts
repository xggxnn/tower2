import fui_Shadow from "../../Generates/Battle/fui_Shadow";
import BattleWin from "../../../gamemodule/Windows/BattleWin";

/** 此文件自动生成，可以直接修改，后续不会覆盖 **/
export default class UI_Shadow extends fui_Shadow {

	moduleWindow: BattleWin;

	public static DependPackages: string[] = ["Battle"];

	public static createInstance(): UI_Shadow {

		return <UI_Shadow>(fui_Shadow.createInstance());
	}
