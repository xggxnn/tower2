...
export default class fui_BattleMain extends fairygui.GComponent {
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_bg3 = <fairygui.GGroup><any>(this.getChildAt(6));
		this.m_bagua2 = <fui_bagua><any>(this.getChildAt(8));
		this.m_bg1 = <fairygui.GGroup><any>(this.getChildAt(9));
		this.m_bagua4 = <fui_bagua><any>(this.getChildAt(11));
		this.m_bg2 = <fairygui.GGroup><any>(this.getChildAt(12));
		this.m_bagua3 = <fui_bagua><any>(this.getChildAt(14));
		this.m_bg4 = <fairygui.GGroup><any>(this.getChildAt(15));
		this.m_haloscenes = <fairygui.GLoader><any>(this.getChildAt(16));
		this.m_atkRange = <fairygui.GImage><any>(this.getChildAt(17));
		this.m_shadow = <fairygui.GLoader><any>(this.getChildAt(18));
		this.m_base0 = <fairygui.GButton><any>(this.getChildAt(19));
		this.m_stone0 = <fui_Stone><any>(this.getChildAt(20));
		this.m_base1 = <fairygui.GButton><any>(this.getChildAt(21));
		this.m_stone1 = <fui_Stone><any>(this.getChildAt(22));
		this.m_base2 = <fairygui.GButton><any>(this.getChildAt(23));
		this.m_base3 = <fairygui.GButton><any>(this.getChildAt(24));
		this.m_stone2 = <fui_Stone><any>(this.getChildAt(25));
		this.m_base4 = <fairygui.GButton><any>(this.getChildAt(26));
		this.m_stone3 = <fui_Stone><any>(this.getChildAt(27));
		this.m_base5 = <fairygui.GButton><any>(this.getChildAt(28));
		this.m_base6 = <fairygui.GButton><any>(this.getChildAt(29));
		this.m_stone4 = <fui_Stone><any>(this.getChildAt(30));
		this.m_base7 = <fairygui.GButton><any>(this.getChildAt(31));
		this.m_stone5 = <fui_Stone><any>(this.getChildAt(32));
		this.m_base8 = <fairygui.GButton><any>(this.getChildAt(33));
