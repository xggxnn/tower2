...
export default class fui_BattleLeftTop extends fairygui.GComponent {
	...
	public m_tip1:fairygui.GComponent;
	public m_tip2:fairygui.GComponent;
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_tip1 = <fairygui.GComponent><any>(this.getChildAt(1));
		this.m_tip2 = <fairygui.GComponent><any>(this.getChildAt(2));
	}
}