...
export default class fui_SelectionMenu extends fairygui.GComponent {
	...
	public static createInstance():fui_SelectionMenu {
		return <fui_SelectionMenu><any>(fairygui.UIPackage.createObject("Menus","SelectionMenu"));
	}
