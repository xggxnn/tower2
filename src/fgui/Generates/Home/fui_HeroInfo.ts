...
export default class fui_HeroInfo extends fairygui.GComponent {
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_icons = <fairygui.GLoader><any>(this.getChildAt(7));
		this.m_atk = <fairygui.GTextField><any>(this.getChildAt(8));
		this.m_atkspeed = <fairygui.GTextField><any>(this.getChildAt(9));
		this.m_cirt = <fairygui.GTextField><any>(this.getChildAt(10));
		this.m_burst = <fairygui.GTextField><any>(this.getChildAt(11));
		this.m_skillname = <fairygui.GTextField><any>(this.getChildAt(12));
		this.m_race = <fairygui.GTextField><any>(this.getChildAt(13));
		this.m_career = <fairygui.GTextField><any>(this.getChildAt(14));
		this.m_special = <fairygui.GTextField><any>(this.getChildAt(15));
		this.m_lookrace = <fui_GeneralBtns><any>(this.getChildAt(16));
		this.m_lookcareer = <fui_GeneralBtns><any>(this.getChildAt(17));
		this.m_lookspecial = <fui_GeneralBtns><any>(this.getChildAt(18));
		this.m_gainmethod = <fui_GeneralBtns><any>(this.getChildAt(19));
		this.m_help = <fairygui.GButton><any>(this.getChildAt(20));
		this.m_upQuality = <fui_GeneralBtns><any>(this.getChildAt(21));
		this.m_upAtk = <fui_GeneralBtns><any>(this.getChildAt(22));
		this.m_upSpeed = <fui_GeneralBtns><any>(this.getChildAt(23));
		this.m_upCrit = <fui_GeneralBtns><any>(this.getChildAt(24));
		this.m_upBurst = <fui_GeneralBtns><any>(this.getChildAt(25));
	}
}