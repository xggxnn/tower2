...
export default class fui_HeroInfo extends fairygui.GComponent {
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_help = <fairygui.GButton><any>(this.getChildAt(21));
		this.m_upQuality = <fui_GeneralBtns><any>(this.getChildAt(22));
		this.m_upAtk = <fui_GeneralBtns><any>(this.getChildAt(23));
		this.m_upSpeed = <fui_GeneralBtns><any>(this.getChildAt(24));
		this.m_upCrit = <fui_GeneralBtns><any>(this.getChildAt(25));
		this.m_upBurst = <fui_GeneralBtns><any>(this.getChildAt(26));
	}
}