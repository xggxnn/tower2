...
export default class fui_HomeMain extends fairygui.GComponent {
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_heroBtn = <fairygui.GButton><any>(this.getChildAt(6));
		this.m_gold = <fairygui.GLabel><any>(this.getChildAt(7));
		this.m_diamond = <fairygui.GLabel><any>(this.getChildAt(8));
		this.m_jadeite = <fairygui.GLabel><any>(this.getChildAt(9));
		this.m_seatBtn = <fui_seatBtn><any>(this.getChildAt(10));
		this.m_fightBtn = <fui_fightBtn><any>(this.getChildAt(11));
