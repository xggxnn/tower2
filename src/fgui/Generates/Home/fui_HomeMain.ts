...
export default class fui_HomeMain extends fairygui.GComponent {
	...
	public m_playsortBtn:fairygui.GButton;
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_gold = <fairygui.GLabel><any>(this.getChildAt(9));
		this.m_diamond = <fairygui.GLabel><any>(this.getChildAt(10));
		this.m_jadeite = <fairygui.GLabel><any>(this.getChildAt(11));
		...
		this.m_setBtn = <fairygui.GButton><any>(this.getChildAt(23));
		this.m_actBtn = <fairygui.GButton><any>(this.getChildAt(24));
		this.m_shopBtn = <fairygui.GButton><any>(this.getChildAt(25));
		this.m_sortBtn = <fairygui.GButton><any>(this.getChildAt(26));
		this.m_bagBtn = <fairygui.GButton><any>(this.getChildAt(27));
		this.m_heroBtn = <fairygui.GButton><any>(this.getChildAt(28));
		this.m_conquestBtn = <fui_conquestBtn><any>(this.getChildAt(29));
		this.m_testBtn = <fairygui.GButton><any>(this.getChildAt(30));
		this.m_playsortBtn = <fairygui.GButton><any>(this.getChildAt(31));
		this.m_maskBtn = <fairygui.GButton><any>(this.getChildAt(33));
	}
}