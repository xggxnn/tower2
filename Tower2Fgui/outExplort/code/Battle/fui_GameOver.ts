...
export default class fui_GameOver extends fairygui.GComponent {
	...
	protected constructFromXML(xml: any): void {
		...
		this.m_synthBtn = <fairygui.GButton><any>(this.getChildAt(7));
		this.m_gainBtn = <fairygui.GButton><any>(this.getChildAt(8));
		this.m_upLevelBtn = <fairygui.GButton><any>(this.getChildAt(9));
